...
;;; LCD Archive Entry:
;;; crypt++|Rod Whitby and Lawrence R. Dodd|kb@cs.umb.edu|
;;; Code for handling all sorts of compressed and encrypted files.|
;;; 04-Feb-1998|2.82|~/misc/crypt++.el.Z|
...
ftp in
   /ftp.cs.umb.edu:/pub/misc/crypt++.el")
