...
;; Version: $Id: net-utils.el,v 1.5 1998/03/11 00:27:18 pbreton Exp pbreton $
;; Keywords: 
;; Time-stamp: <1998-03-19 19:14:35 pbreton>
...
(defconst net-utils-version (substring "$Revision: 1.5 $" 11 -2)
  ...
  $Id: net-utils.el,v 1.5 1998/03/11 00:27:18 pbreton Exp pbreton $")
...
(defcustom ping-program-options 
  (and (memq system-type (list 'gnu/linux 'irix))
       (list "-c" "4"))
