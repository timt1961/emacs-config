h07124
s 01161/00000/00000
d D 1.1 06/02/02 07:22:08 utt 1 0
...
;; Version: $Id: planner-config.el,v 0.0 2006/02/01 07:24:30 utt Exp $
;; Keywords: 
...
;;; Commentary:
;; This is the configuration file for planner mode. 
;;
;; Planner.el support.
(add-to-list 'load-path "~/emacs/lib/emacs/site-lisp/emacs-wiki/")
(add-to-list 'load-path "~/emacs/lib/emacs/site-lisp/planner/")
(add-to-list 'load-path "~/emacs/lib/emacs/site-lisp/remember/")
(require 'planner)
...
;;
;; Sacha Chua's planner-config.el file (Just to show what's possible)
